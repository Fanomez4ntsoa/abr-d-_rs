                    ...
                    <div class="col-lg-6 col-sm-12 order-3 order-lg-2">
                        <div class="newsfeed-form single-entry mt-5">
                            <div class="entry-inner current-entry">
                                <h4 class="widget-title">{{get_phrase('Votre compte a été désactivé')}}</h4>
                                <p class="ellipsis-line-3 pe-2 text-dark p-2 ">{{get_phrase('Cliquez sur le bouton pour demander l\'activation de votre compte auprès de l\'administrateur')}}</p>
                                @if($acc_act_req)
                                ...
                                @else
                                    <form action="{{ route('frontend.account_enble_req', ['id' => auth()->user()->id]) }}">
                                        <button type="submit" class="btn common_btn w-100">{{ get_phrase('Demander l\'activation du compte') }}</button>
                                    </form>
                                @endif
                            </div> 
                        </div> 
