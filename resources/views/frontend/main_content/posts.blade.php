                    ...
                    <div class="ava-info d-flex align-items-center">
                                            ...
                                            <div class="h_right_text">
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="d-flex">
                                                        ...
                                                        <p>{{ get_phrase('Lives in') }}
                                                            <strong>{{ $post->getUser->address }}</strong> </p>
                                            ...
                                            @if ($friendAccepted->count() > 0 && $friendAccepted->value('is_accepted') == 1)
                                                <ul class="d-flex eHfooter">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                            ...
                                                            <li><a href="javascript:void(0)"
                                                                    ...
                                                                    class="dropdown-item custom_unfrind_button"> <i
                                                                        class="fa-solid fa-xmark"></i>{{ get_phrase('Unfriend') }}</a>
                                                            </li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="{{ route('chat', $post->user_id) }}"
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <a class="dropdown-item" href="javascript:void(0)"
                                                                        onclick="showCustomModal('<?php echo route('block_user', $post->post_id); ?>', 'Block')">{{ get_phrase('Block') }}</a>
                                                                </li>
                                                ...
                                                <ul class="d-flex eHfooter">
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="javascript:void(0)"
                                                            ...
                                                            title="{{ get_phrase('Cancle Friend Request') }}"><i
                                        ...
                                        @else
                                            <ul class="d-flex eHfooter">
                                                ...
                                                <li> <a href="javascript:void(0)"
                                                        ...
                                                        {{ get_phrase('Add Friend') }} </a></li>

                                                <li> <a href="{{ route('chat', $post->user_id) }}"
                                                        class="btn common_btn ac_btn"><i
                                                            class="fa-solid fa-message"></i>
                            ...
                            <div class="entry-header d-flex justify-content-between">
                                ...
                                <div class="ava-info d-flex align-items-center">
                                    ...
                                    <div class="ava-desc ms-2">
                                        ...
                                        <small
                                            class="meta-time text-muted">{{ date('M d ', strtotime($post->created_at)) }}
                                                ...
                                                <ul>
                                                    <li class="d-flex">
                                                        ...
                                                        {{-- @php
                                                            ...
                                                            @endphp --}}
                                                        <p> {{ get_phrase('0 Mutual friend') }}</p>
                                                    </li>
                                                    <li class="d-flex">
                                                        <i class="fa-solid fa-house-user"></i>
                                                        <p>{{ get_phrase('Lives in') }}
                        ...
                        <div class="ava-desc ms-2">
                            ...
                            <h3 class="mb-0">
                                                    ...
                                                    <div class="h_right_text">
                                                        ...
                                                        <ul class="el_shift">
                                                            ...
                                                            <li class="d-flex">
                                                                ...
                                                                <p>{{ get_phrase('Lives in') }}
                                                                    <strong>{{ $post->getUser->address }}</strong>
                                                                </p>
                                ...
                                @if (($tagged_user_ids && count($tagged_user_ids) > 0) || $post->activity_id > 0)
                            ...
                            @if ($post->privacy == 'public')
                                <span class="meta-privacy text-muted"
                                    title="{{ ucfirst(get_phrase($post->privacy)) }}"><i
                                        class="fa-solid fa-earth-americas"></i></span>
                    ...
                    <div class="post-controls dropdown">
                        ...
                        <ul class="dropdown-menu post_dots" aria-labelledby="navbarDropdown">
                            ...
                            <li>
                                ...
                                @if (Auth::check() && $save_posts->contains($post->post_id))
                                    <a class="dropdown-item"
                                        href="{{ route('unsave_post', ['id' => $post->post_id]) }}">
                                ...
                                @else
                                    <a class="dropdown-item"
                                        href="{{ route('save_post', ['id' => $post->post_id]) }}">
                        ...
                        <div class="py-1">
                            ...
                            <div class="text-quote image">
                                ...
                                @if (isset($fundShare->cover_photo))
                                    <a class="ellipsis-line-1 ellipsis-line-2"
                                        href="{{ route('fundraiser.profile', $fundShare->id) }}">
