                ...
                <article class="single-entry batch-entry h-100 p-0">
                    <div class="entry-txt p-8">
                        ...
                        <div class="batch E_new_batch">
                            <div class="confirmation-card {{ $view_type == 'simple' ? 'simple-border' : 'pro-border' }}">
                                ...
                                <!-- Titre principal -->
                                <h4 class="text-center mb-4">{{ get_phrase('Confirm and Pay for your') }} {{ ucfirst($view_type) }} {{ get_phrase('Badge') }}</h4>

                                <!-- Section du prix -->
                                <div class="price-section">
                                    <h4>
                                        <i class="fa-solid fa-money-bill-wave"></i>
                                        {{ get_phrase("You'll be billed") }} {{ currency($badge_price) }} {{ get_phrase('per month.') }}
                                    </h4>
                                </div>
                                ...
                                <div class="benefits-section">
                                    ...
                                    {{-- <form action="{{ route('badge.payment_configuration', ['id' => auth()->user()->id]) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <button type="submit" class="btn btn-pay-now">
                                            {{ get_phrase('Pay Now') }} <i class="fa-solid fa-arrow-right"></i>
                                        </button>
                                    </form> --}}
                                    <form action="{{ route('badge.payment_configuration', ['id' => auth()->user()->id]) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <ul class="entry_badge">
                                            @if($view_type == 'simple')
                                                ...
                                                <li>
                                                    <i class="fa-solid fa-check"></i>
                                                    <div class="entry_badge_text">
                                                        <label for="exclusive">Contenu du Badge Fondateur {{ currency($badge_price) }} à vie : Statut Fondateur affiché à vie sur votre profil</label>
                                                    </div>
                                                </li>
                                                <li>
                                                    <i class="fa-solid fa-check"></i>
