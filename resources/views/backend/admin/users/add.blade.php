        ...
        <div class="eSection-wrap-2">
          <div class="eForm-layouts">
            <form method="POST" action="{{ route('admin.user.store') }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  <label for="password" class="form-label eForm-label">{{ get_phrase('mot de passe') }}</label>
                  <input type="password" class="form-control eForm-control" id="password" name="password" placeholder="{{ get_phrase('mot de passe') }}">
                </div>
