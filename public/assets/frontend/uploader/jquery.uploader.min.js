    ...
    $.fn.imageUploader = function (options) {
        ...
        let createContainer = function () {
            let $container = $("<div>", { class: "image-uploader" }),
                ...
                $i = $("<i>", { class: "fa-solid fa-cloud-arrow-up text-secondary", text: "" }).appendTo($textContainer),
        ...
        let createImg = function (src, id) {
            let $container = $("<div>", { class: "uploaded-image" }),
                ...
                $i = $("<i>", { class: "fa-solid fa-trash text-8px", text: "" }).appendTo($button);
            if (plugin.settings.preloaded.length) {
        ...
        let setPreview = function ($container, files) {
            ...
            $(files).each(function (i, file) {
                ...
                setTimeout(function(){
                    var uploadedFileName = file.name.split('.').pop();
                    if(uploadedFileName == 'mp4' || uploadedFileName == 'wmv' || uploadedFileName == 'avi' || uploadedFileName == 'mkv' || uploadedFileName == 'webm'){
                        $('.uploaded-image img').eq(dataTransfer.items.length-1).attr('src', 'public/assets/frontend/uploader/play.png');
                    }else if(uploadedFileName == 'jpg' || uploadedFileName == 'jpeg' || uploadedFileName == 'png' || uploadedFileName == 'gif'){
                        
                    }else{
                        $('.uploaded-image img').eq(dataTransfer.items.length-1).attr('src', 'public/assets/frontend/uploader/file.png');
                    }
                });
