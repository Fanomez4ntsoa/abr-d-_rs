                                  ...
                                  <div class="card-head">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="join_groups">
                                                <?php if(Auth::check() ? $join = \App\Models\Group_member::where('group_id',$group->id)->where('user_id',auth()->user()->id)->count() : $join = 0);
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <?php else: ?>
                                                        <a href="<?php echo e(route('login')); ?>" class="btn common_btn join_btn">
                                                    <?php endif; ?>
                                                        <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<?php endif; ?><?php /**PATH C:\Users\DELL\Desktop\Voary\Piscine de Romain\AbracadamallReseau\AbracadamallReseau\resources\views/frontend/groups/groups.blade.php ENDPATH**/ ?>