    ...
    <div class="modal-body">
     ...
     <?php endif; ?>
        ...
        <div class="mt-action">
            <?php if(!empty($reciver_data)): ?>
            <!-- Chat textarea -->
            <form class="ajaxForm" action="<?php echo e(route('chat.save')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?><?php /**PATH C:\Users\USER\Documents\GitHub\abr-d-_rs\resources\views/frontend/chat/chat.blade.php ENDPATH**/ ?>