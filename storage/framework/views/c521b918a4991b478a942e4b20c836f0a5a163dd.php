<form class="ajaxForm" action="<?php echo e(route('add.image.album')); ?>" method="post" enctype="multipart/form-data">
  ...
  <?php echo $__env->make('frontend.common_scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Documents\GitHub\abr-d-_rs\resources\views/frontend/groups/album_image.blade.php ENDPATH**/ ?>