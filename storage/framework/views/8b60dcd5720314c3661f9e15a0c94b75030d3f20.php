...
foreach ($__currentLoopData as $loopIndex => $post): $__env->incrementLoopIndices();
                            ...
                            <h3 class="mb-0">
                                ...
                                <?php if (count($tagged_user_ids) > 0 || $post->activity_id > 0): ?>
                                    ...
                                    <?php if (count($tagged_user_ids) > 0): ?>
                                        ...
                                        <?php $__currentLoopData = $tagged_user_ids;
                                        $__env->addLoop($__currentLoopData);
                                        foreach ($__currentLoopData as $key => $tagged_user_id): $__env->incrementLoopIndices();
                                            $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH D:\asaRomain\Piscine de Romain Avril\resources\views/frontend/main_content/posts.blade.php ENDPATH**/ ?>