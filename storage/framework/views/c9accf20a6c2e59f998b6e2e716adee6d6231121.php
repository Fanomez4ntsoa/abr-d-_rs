<div class="sidebar">
    ...
    <ul class="nav-links">
        ...
        <li class="nav-links-li  <?php if(Route::currentRouteName() == 'admin.video' ||
                ...
                Route::currentRouteName() == 'admin.video.edit'): ?> showMenu <?php endif; ?>">
            <div class="iocn-link">
                <a href="#">
                    <div class="sidebar_icon">
                        <i class="fa-solid fa-video"></i>
                    </div>
                    <span class="link_name"><?php echo e(get_phrase('video')); ?></span>
                </a>
                <span class="arrow">
                    <svg xmlns="http://www.w3.org/2000/svg" width="4.743" height="7.773" viewBox="0 0 4.743 7.773">
                        <path id="navigate_before_FILL0_wght600_GRAD0_opsz24"
            ...
            <ul class="sub-menu">
                <li><a class="<?php if(Route::currentRouteName() == 'admin.video'): ?> Active <?php endif; ?>"
                        href="<?php echo e(route('admin.video')); ?>"><?php echo e(get_phrase('Videos')); ?></a></li> 
                <li><a class="<?php if(Route::currentRouteName() == 'admin.video.create'): ?> Active <?php endif; ?>"
                        href="<?php echo e(route('admin.video.create')); ?>"><?php echo e(get_phrase('Add Video')); ?></a></li>
                <li><a class="<?php if(Route::currentRouteName() == 'admin.view.video.category'): ?> Active <?php endif; ?>"
                        href="<?php echo e(route('admin.view.video.category')); ?>"><?php echo e(get_phrase('Category')); ?></a></li>
                <li><a class="<?php if(Route::currentRouteName() == 'admin.create.video.category'): ?> Active <?php endif; ?>"
                        href="<?php echo e(route('admin.create.video.category')); ?>"><?php echo e(get_phrase('Create Category')); ?></a></li>
            </ul>
        </li>
...
<?php /**PATH C:\Users\DELL\Desktop\Voary\Piscine de Romain\AbracadamallReseau\AbracadamallReseau\resources\views/backend/admin/sidebar.blade.php ENDPATH**/ ?>