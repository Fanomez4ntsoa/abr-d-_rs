                                ...
                                <div class="benefits-section">
                                    ...
                                    <form action="<?php echo e(route('badge.payment_configuration', ['id' => auth()->user()->id])); ?>" method="POST" enctype="multipart/form-data">
                                        ...
                                        <ul class="entry_badge">
                                            ...
                                            <?php if($view_type == 'pro'): ?>
                                                <li>
                                                    <i class="fa-solid fa-check"></i>
                                                    <div class="entry_badge_text">
                                                        <label for="exclusive"><?php echo e(get_phrase('Exclusive verified badge')); ?></label>
                                        ...
                                        <button type="submit" class="btn btn-pay-now">
                                            <?php echo e(get_phrase('Pay Now')); ?> <i class="fa-solid fa-arrow-right"></i>
                                        </button>
                                    </form>
                                </div>
                            </div>
...
</div><?php /**PATH C:\Users\DELL\Desktop\Voary\Piscine de Romain\AbracadamallReseau\AbracadamallReseau\resources\views/frontend/badge/badge_info.blade.php ENDPATH**/ ?>