            ...
            <nav class="menu-wrap">
                ...
                <ul>
                    ...
                    <li class="<?php if (
                                ...
                                ): ?> active <?php endif; ?>"><a href="<?php echo e(route('profile')); ?>"><img
                    ...
                    <li class="<?php if (
                                ...
                                ): ?> active <?php endif; ?>"><a href="<?php echo e(route('videos')); ?>"><img
                    ...
                    <li class="<?php if (
                                ...
                                ): ?> active <?php endif; ?>"><a href="<?php echo e(route('groups')); ?>"><img
                    ...
                    <li class="<?php if (
                                ...
                                ): ?> active <?php endif; ?>"><a href="<?php echo e(route('blogs')); ?>"><img
                    ...
                    <li class="<?php if (
                                    ...
                                    Route::currentRouteName() == 'single.event'
                                ): ?> active <?php endif; ?>"><a href="<?php echo e(route('event')); ?>"><img
                    ...
                    <?php if (addon_status('paid_content') == 1): ?>
                        <li class="<?php if (
                                        Route::currentRouteName() == 'paid.content' ||
...
<?php /**PATH D:\asaRomain\AbracadamallReseau\resources\views/frontend/left_navigation.blade.php ENDPATH**/ ?>