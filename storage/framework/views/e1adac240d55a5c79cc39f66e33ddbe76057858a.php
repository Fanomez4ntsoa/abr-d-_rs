<?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="single-entry single-item-countable" id="video-<?php echo e($video->id); ?>"> 
                ...
                <div class="ava-info d-flex align-items-center">
                    ...
                    <div class="ava-desc ms-2">
                        ...
                        <span class="meta-time text-muted">     
                            <?php echo e($video->created_at->timezone(Auth::check() ? Auth::user()->timezone : 'UTC')->format("M d")); ?> at <?php echo e(date('H:i A', strtotime($video->created_at))); ?>
            ...
            <div class="e_comment">
                <div class="entry-footer">
                    <div class="footer-share d-flex justify-content-around">
                        ...
                        <span class="entry-react"><a href="javascript:void(0)" onclick="$('#user-comments-<?php echo e($post->post_id); ?>').toggle();"><img width="19px" src="<?php echo e(asset('storage/images/comment2.svg')); ?>"><?php echo e(get_phrase('Comments')); ?></a></span>
                        <span class="entry-react" data-bs-toggle="modal" data-bs-target="#exampleModal"><a
                                href="javascript:void(0)" onclick="showCustomModal('<?php echo e(route('load_modal_content', ['view_path' => 'frontend.main_content.share_post_modal', 'post_id' => $post->post_id] )); ?>', '<?php echo e(get_phrase('Share post')); ?>');"><img width="19px" src="<?php echo e(asset('storage/images/share2.svg')); ?>"><?php echo e(get_phrase('Share')); ?></a></span>
                        <!-- Post share modal -->
                    </div>
                      <?php
        ...
        <div class="user-comments s_comment  d-hidden bg-white" id="user-comments-<?php echo e($post->post_id); ?>">
            <div class="comment-form d-flex mb-1">
                <?php if(auth()->guard()->check()): ?> 
                    <img src="<?php echo e(get_user_image(Auth()->user()->photo, 'optimized')); ?>" alt="" class="h-39 rounded-circle img-fluid" width="40px">
                <?php endif; ?>
    ...
    <?php echo $__env->make('frontend.initialize', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Downloads\Compressed\Piscine de Romain Avril\resources\views/frontend/video-shorts/single-video.blade.php ENDPATH**/ ?>