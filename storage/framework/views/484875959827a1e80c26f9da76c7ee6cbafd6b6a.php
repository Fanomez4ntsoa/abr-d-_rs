    ...
    <div class="product-form  mb-3 bg-white p-3 pb-12 radius-8">
        <div class="nm_place d-flex pagetab-head  align-items-center justify-content-between">
            ...
            <div class="">
                ...
                <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="btn common_btn"> <i class="fa fa-plus-circle"></i><?php echo e(get_phrase('create')); ?></a>
                <?php endif; ?>
        ...
        <div class="product-filter market-filter mt-3">
            ...
            <form method="GET" action="<?php echo e(route('filter.product')); ?>" class=" row">
                <div class="form-group mb-12">
                    <input type="search" class="submit_on_enter inputs " name="search" value="<?php if(isset($_GET['search']) && $_GET['search']!="" ): ?><?php echo e($_GET['search']); ?><?php endif; ?>" class="bg-secondary rounded" placeholder="Tapez pour rechercher">
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group ">
                            <input type="text" name="location" class="submit_on_enter pl-18" value="<?php if(isset($_GET['location']) && $_GET['location']!="" ): ?><?php echo e($_GET['location']); ?><?php endif; ?>"  placeholder="Localisation">
                        </div>
                    </div>
                </div>
            </form>
...
<?php /**PATH C:\Users\DELL\Desktop\Voary\Piscine de Romain\AbracadamallReseau\AbracadamallReseau\resources\views/frontend/marketplace/products.blade.php ENDPATH**/ ?>