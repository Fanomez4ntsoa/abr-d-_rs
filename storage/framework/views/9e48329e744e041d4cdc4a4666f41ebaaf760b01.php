...
<div class="page-wrap">
    <div class="product-form new_job_f  mb-3 bg-white p-20 radius-8">
            <div class="nm_place njob d-flex pagetab-head border-none  align-items-center justify-content-between" >
                <h1 class="h3"><?php echo e(get_phrase('Jobs')); ?></h1>
                <div class="btn-inline ">
                    <a href="<?php echo e(route('create.job')); ?>" class="btn common_btn <?php if(Route::currentRouteName() == 'create.job'): ?> primary <?php else: ?> dash <?php endif; ?> "> <i class="fa fa-circle-plus me-2"></i><?php echo e(get_phrase('Create Job')); ?></a>
                    
                </div>
            </div>
            <div class="gr-search mt-3">
                <form action="<?php echo e(route('search.job')); ?>" class="ag_form" method="GET">
                    <input type="text" class="bg-secondary form-control  rounded" name="search" value="<?php if(isset($_GET['search'])): ?> <?php echo e($_GET['search']); ?> <?php endif; ?>" placeholder="Search Job">
                    <span class="i fa fa-search"></span>
                </form>
            </div>
            <ul class="Etab j_etab d-flex ">
                <li><a href="<?php echo e(route('jobs')); ?>" class=" <?php if(Route::currentRouteName() == 'jobs'): ?> actives <?php endif; ?> "> <?php echo e(get_phrase('Explore Jobs')); ?></a></li>
                 <li><a href="<?php echo e(route('job.myjob')); ?>" class="<?php if(Route::currentRouteName() == 'job.myjob'): ?> actives  <?php endif; ?>"><?php echo e(get_phrase('My Job')); ?> </a></li>
                 <li><a href="<?php echo e(route('job.save.view')); ?>" class="<?php if(Route::currentRouteName() == 'job.save.view'): ?> actives <?php endif; ?>"><?php echo e(get_phrase('Saved Job')); ?></a></li>
                 <li><a href="<?php echo e(route('job.my.apply.list')); ?>" class="<?php if(Route::currentRouteName() == 'job.my.apply.list'): ?> actives <?php endif; ?>"><?php echo e(get_phrase('My Application')); ?></a></li>
                 <li><a href="<?php echo e(route('job.payment.history')); ?>" class="<?php if(Route::currentRouteName() == 'job.payment.history'): ?> actives <?php endif; ?>"><?php echo e(get_phrase('History')); ?></a></li>
             </ul>
        ...
        <?php if(count($jobs) > 0): ?>
         <div class="bg-white radius-8 p-20">
            <div class="row" id="jobdatashow"> 
                <?php echo $__env->make('frontend.jobs.job-single', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
         </div>
        <?php else: ?>
...
<?php /**PATH C:\Users\USER\Downloads\Compressed\Piscine de Romain Avril\resources\views/frontend/jobs/jobs.blade.php ENDPATH**/ ?>