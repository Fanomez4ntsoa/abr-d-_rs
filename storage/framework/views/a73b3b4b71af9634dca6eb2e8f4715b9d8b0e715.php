        ...
        <div class="d-flex pagetab-head  justify-content-between">
            ...
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" 
                    class="btn common_btn"> <i class="fa fa-plus-circle"></i><?php echo e(get_phrase('Create Page')); ?></a>
            <?php endif; ?>
        </div>
...
<?php /**PATH C:\Users\USER\Downloads\Compressed\Piscine de Romain Avril\resources\views/frontend/pages/pages.blade.php ENDPATH**/ ?>