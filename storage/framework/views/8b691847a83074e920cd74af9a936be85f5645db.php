<div class="page-wrap">
    <div class="d-flex pagetab-head video_wrap_title   align-items-center justify-content-between mb-3 p-20 radius-8 bg-white">
        <h3 class="h5 mb-0"><span><i class="fa-solid fa-file-video"></i></span> <?php echo e(get_phrase('Watch')); ?></h3>
        <div class="w-80 gap_10">
            <a href="javascript:void(0)" onclick="showCustomModal('<?php echo e(route('load_modal_content', ['view_path' => 'frontend.video-shorts.create'])); ?>', '<?php echo e(get_phrase('Create Video & Shorts ')); ?>');" class="btn common_btn" data-bs-toggle="modal"
                data-bs-target=""> <i
                class="fa-solid fa-clapperboard me-2"></i><?php echo e(get_phrase('Create')); ?></a>
            <a href="<?php echo e(route('shorts')); ?>" class="btn <?php if(Route::currentRouteName() == 'shorts'): ?> common_btn_2 <?php else: ?> common_btn <?php endif; ?> "><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                </svg><?php echo e(get_phrase('Shorts')); ?></a>
            <a href="<?php echo e(route('videos')); ?>" class="btn <?php if(Route::currentRouteName() == 'videos'): ?> common_btn_2 <?php else: ?> common_btn <?php endif; ?> "><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                </svg><?php echo e(get_phrase('Videos')); ?></a>
            <a href="<?php echo e(route('save.all.view')); ?>"  data-bs-toggle="tooltip" data-bs-placement="bottom" title="Saved Video"><span class=" <?php if(Route::currentRouteName() == 'save.all.view'): ?> common_btn_2 <?php else: ?> common_btn <?php endif; ?> "><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="entry-text sav_text">
                        ...
                        <div class="d-flex my-2">
                            ...
                            <div class="avatar save_avater">
                                <a href="#!"><img class="avatar-img rounded-circle h-39" src="<?php echo e(get_user_image($video->getVideo->getUser->photo,'optimized')); ?>"
                                        alt="" ></a>
                            </div>
...
<?php /**PATH C:\Users\USER\Downloads\Compressed\Piscine de Romain Avril\resources\views/frontend/video-shorts/saved.blade.php ENDPATH**/ ?>