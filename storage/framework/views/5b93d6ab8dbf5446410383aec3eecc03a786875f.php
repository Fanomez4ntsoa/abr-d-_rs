<form class="ajaxForm" action="<?php echo e(route('videos.store')); ?>" method="POST" enctype="multipart/form-data">
    ...
    <button type="submit" class="w-100 btn common_btn"><?php echo e(get_phrase('Create')); ?></button>
</form>

<?php echo $__env->make('frontend.initialize', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Downloads\Compressed\Piscine de Romain Avril\resources\views/frontend/video-shorts/create.blade.php ENDPATH**/ ?>