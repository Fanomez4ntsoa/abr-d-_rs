<?php
    ...
    foreach ($friendships as $friendship) {
        ...
        // Decode the JSON object as associative arrays and get the keys pregnant women keys
    ...
    // Block User Each Other ----- if connect
    if (Auth::check()) {
        $blockedByUser = DB::table('block_users')
            ->where('user_id', auth()->user()->id)
            ->pluck('block_user')
            ->toArray();
        $blockedByOthers = DB::table('block_users')
            ->where('block_user', auth()->user()->id)
            ->pluck('user_id')
            ->toArray();
        ...
        <div class="single-item-countable single-entry" id="postIdentification<?php echo e($post->post_id); ?>">
            <div class="entry-inner">
                ...
                <div class="entry-header d-flex justify-content-between">
                    <div class="ava-info d-flex align-items-center">
                                    ...
                                    <div class="hoverFeature">
                                                ...
                                                <ul>
                                                    <li class="d-flex">
                                                        ...
                                                        <?php
                                                            ...
                                                            $my_data = DB::table('users')
                                                                ->where('id', $post->getUser->id)
                                                                ->first();
                                        ...
                                        <?php if($friend > 0): ?>
                                            <?php if($friendAccepted->count() > 0 && $friendAccepted->value('is_accepted') == 1): ?>
                                                <ul class="d-flex eHfooter">
                                                    <li>
                                                        <a href="#" class="btn common_btn ac_btn" id="btnGroupDrop1" data-bs-toggle="dropdown" aria-expanded="false">
                                                            <i class="fa-solid fa-user-group"></i> <?php echo e(get_phrase('Friend')); ?>

                                                        </a>
                                                        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                            <li>
                                                                <a href="javascript:void(0)"
                                                                    onclick="ajaxAction('<?php echo route('user.unfriend', $user_id); ?>')"
                                                                    class="dropdown-item custom_unfrind_button">
                                                                    <i class="fa-solid fa-xmark"></i><?php echo e(get_phrase('Unfriend')); ?>
                                                    ...
                                                    <li>
                                                        <a href="<?php echo e(route('chat', $post->user_id)); ?>"
                                                            class="btn common_btn ac_btn">
                                                            <i class="fa-solid fa-message"></i> <?php echo e(get_phrase('Message')); ?>
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item" href="javascript:void(0)"
                                                                        onclick="showCustomModal('<?php echo route('block_user', $post->post_id); ?>', 'Block')">
                                                                        <?php echo e(get_phrase('Block')); ?>
                                            ...
                                            <?php else: ?>
                                                <ul class="d-flex eHfooter">
                                                    <li>
                                                        <a href="javascript:void(0)"
                                                            onclick="ajaxAction('<?php echo route('user.unfriend', $user_id); ?>')"
                                                            class="btn common_btn ac_btn" data-bs-toggle="tooltip" data-bs-placement="top"
                                                            title="<?php echo e(get_phrase('Cancle Friend Request')); ?>">
                                                            <i class="fa-solid fa-xmark"></i> <?php echo e(get_phrase('Cancel')); ?>
                                        ...
                                        <?php else: ?>
                                            <ul class="d-flex eHfooter">
                                                <li>
                                                    <a href="javascript:void(0)"
                                                        onclick="ajaxAction('<?php echo route('user.friend', $post->user_id); ?>')"
                                                        class="btn common_btn ac_btn">
                                                        <i class="fa-solid fa-plus"></i> <?php echo e(get_phrase('Add Friend')); ?>
                            ...
                            <div class="entry-header d-flex justify-content-between">
                                <div class="ava-info d-flex align-items-center">
                                    ...
                                    <div class="ava-desc ms-2">
                                        ...
                                        <small class="meta-time text-muted">
                                            <?php echo e(date('M d ', strtotime($post->created_at))); ?> at <?php echo e(date('H:i A', strtotime($post->created_at))); ?>

                                        </small>
                                        <?php if($post->privacy == 'public'): ?>
                                            <span class="meta-privacy text-muted">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <li>
                                            <a class="dropdown-item" href="#">
                                                <img src="<?php echo e(asset('assets/frontend/images/save.png')); ?>" alt="">
                                                <?php echo e(get_phrase('Save Video')); ?>

                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="#">
                                                <img src="<?php echo e(asset('assets/frontend/images/link.png')); ?>" alt="">
                                                <?php echo e(get_phrase('Copy Link')); ?>

                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="#">
                                                <img src="<?php echo e(asset('assets/frontend/images/report.png')); ?>" alt="">
                                                <?php echo e(get_phrase('Report')); ?>
                        ...
                        <?php elseif(isset($type) && $type == 'user_post'): ?>
                            <div class="eUserFeature">
                                ...
                                <?php if(Auth::check() && Auth()->user()->id != $post->user_id): ?>
                                    <div class="hoverFeature">
                                        <div class="h_top">
                                            <div class="h_eImage">
                                                <img src="<?php echo e(get_user_image($post->user_id, 'optimized')); ?>">
                                        ...
                                        <div class="h_top">
                                            ...
                                            <div class="h_right_text">
                                                ...
                                                <ul>
                                                    <li class="d-flex">
                                                        <i class="fas fa-user-friends"></i>
                                                        <p><?php echo e(get_phrase('0 Mutual friend')); ?></p>
                                                    </li>
                                                    <li class="d-flex">
                                                        <i class="fa-solid fa-house-user"></i>
                                                        <p><?php echo e(get_phrase('Lives in')); ?> <strong><?php echo e($post->getUser->address); ?></strong></p>
                        ...
                        <div class="ava-desc ms-2">
                            <h3 class="mb-0">
                                <?php if(isset($type) && $type == 'page'): ?>
                                    <a class="text-black ms-0" href="<?php echo e(route('single.page', $post->id)); ?>"><?php echo e($post->title); ?></a>
                                <?php elseif(isset($type) && $type == 'group'): ?>
                                    <a class="text-black ms-0" href="<?php echo e(route('user.profile.view', $post->user_id)); ?>"><?php echo e($post->name); ?></a>
                                <?php else: ?>
                                    <?php
                                    ...
                                    <div class="eUserFeature">
                                        <a class="text-black ms-0 badge" href="<?php echo e(route('user.profile.view', $post->user_id)); ?>"><?php echo e($post->getUser->name); ?>
                                            ...
                                            <?php if(Auth::check() && $post->user_id != auth()->user()->id): ?>
                                                ...
                                                <?php else: ?>
                                                    <a href="javascript:void(0)"
                                                        onclick="ajaxAction('<?php echo route('user.follow', $post->user_id); ?>')">
                                                        <?php echo e(get_phrase('Follow')); ?>
                                    ...
                                    <?php if($post->post_type == 'share'): ?>
                                        ...
                                        <div class="ava-desc ms-2">
                                            <h3 class="mb-0">
                                                ...
                                                <?php if(($tagged_user_ids && count($tagged_user_ids) > 0) || $post->activity_id > 0): ?>
                                                    ...
                                                    <?php if($post->activity_id > 0): ?>
                                                        ...
                                                        <?php else: ?>
                                                            <span class="text-muted"><?php echo e(get_phrase('feeling')); ?></span>
                                                    ...
                                                    <?php if(count($tagged_user_ids) > 0): ?>
                                                        ...
                                                        <?php $__currentLoopData = $tagged_user_ids; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tagged_user_id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <a class="text-black" href="<?php echo e(route('profile')); ?>">
                                                                <?php echo e(DB::table('users')->where('id', $tagged_user_id)->value('name')); ?>
                                                ...
                                                <?php if(!empty($post->location)): ?>
                                                    <small class="text-muted"><?php echo e(get_phrase('in')); ?></small>
                                                    <a href="https://www.google.com/maps/place/<?php echo e($post->location); ?>" target="_blank"><?php echo e($post->location); ?></a>
                                                <?php endif; ?>
                                            </h3>
                                            <small class="meta-time text-muted"><?php echo e(date_formatter($post->created_at, 2)); ?></small>
                                            <?php if($post->privacy == 'public'): ?>
                                                <span class="meta-privacy text-muted" title="<?php echo e(ucfirst(get_phrase($post->privacy))); ?>">
                                                    <i class="fa-solid fa-earth-americas"></i>
                                                </span>
                                    ...
                                    <div class="post-controls dropdown">
                                        ...
                                        <ul class="dropdown-menu post_dots" aria-labelledby="navbarDropdown">
                                            ...
                                            <li>
                                                <?php if(Auth::check() && $save_posts->contains($post->post_id)): ?>
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0)" value="copy"
                                                    onclick="copyToClipboard('copy_post_<?php echo e($post->post_id); ?>')">
                                                    <img src="<?php echo e(asset('storage/images/link.png')); ?>" alt="">
                                                    <?php echo e(get_phrase('Copy Link')); ?>
                                            ...
                                            <?php if(Auth::check() && $post->user_id == auth()->user()->id): ?>
                                                <?php if($post->post_type != 'live_streaming' && $post->location == ''): ?>
                                                    <li>
                                                        <a class="dropdown-item" href="javascript:void(0)"
                                                            ...
                                                            <i class="fa-solid fa-pencil"></i> <?php echo e(get_phrase('Edit')); ?>
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="javascript:void(0)"
                                                        onclick="confirmAction('<?php echo route('post.delete', ['post_id' => $post->post_id]); ?>', true)">
                                                        <i class="fa-solid fa-trash-can"></i> <?php echo e(get_phrase('Delete')); ?>
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0)"
                                                    ...
                                                    <img src="<?php echo e(asset('storage/images/report.png')); ?>" alt="">
                                                    <?php echo e(get_phrase('Report')); ?>
                                ...
                                <div class="entry-content pt-2">
                                    <!-- post description -->
                                    <?php if($post->post_type == 'general' || $post->post_type == 'profile_picture' || $post->post_type == 'cover_photo' || $post->post_type == 'paid_content'): ?>
                                            ...
                                            <div class="text-quote image">
                                                <?php if(isset($fundShare->cover_photo)): ?>
                                                    <a class="ellipsis-line-1 ellipsis-line-2" href="<?php echo e(route('fundraiser.profile', $fundShare->id)); ?>">
                                                        <img src="<?php echo e(asset('assets/frontend/images/campaign/' . $fundShare->cover_photo)); ?>" class="card-img-top" alt="blog">
                                                        <div class="fundraiser-text">
                                                            <img src="<?php echo e(get_user_image($user_info->id, 'optimized')); ?>" class="rounded-circle user_image_show_on_modal" alt="...">
                                    ...
                                    <div class="entry-footer">
                                        <div class="footer-share d-flex justify-content-around">
                                            <span class="entry-react post-react">
                                                ...
                                                <ul class="react-list">
                                                    <li>
                                                        <a href="javascript:void(0)" onclick="myReact('post', 'like', 'update', <?php echo e($post->post_id); ?>)">
                                                            <img src="<?php echo e(asset('storage/images/like.svg')); ?>" alt="Like" style="margin-right: 1px;">
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" onclick="myReact('post', 'love', 'update', <?php echo e($post->post_id); ?>)">
                                                            <img src="<?php echo e(asset('storage/images/love.svg')); ?>" alt="Love" style="width: 30px; margin-top: 2px;">
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" onclick="myReact('post', 'haha', 'update', <?php echo e($post->post_id); ?>)">
                                                            <img src="<?php echo e(asset('storage/images/haha.svg')); ?>" alt="Haha">
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" onclick="myReact('post', 'sad', 'update', <?php echo e($post->post_id); ?>)">
                                                            <img src="<?php echo e(asset('storage/images/sad.svg')); ?>" class="mx-1" alt="Sad">
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" onclick="myReact('post', 'angry', 'update', <?php echo e($post->post_id); ?>)">
                                                            <img src="<?php echo e(asset('storage/images/angry.svg')); ?>" alt="Angry">
                                                        </a>
                                                    </li>
                                                </ul>
                                            </span>
                                        ...
                                        <div class="entry-meta py-2 d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="post-comment">
                                                <ul>
                                                    <li>
                                                        <a onclick="$('#user-comments-<?php echo e($post->post_id); ?>').toggle();" href="javascript:void(0)">
                                                            <span id="post_comment_count<?php echo e($post->post_id); ?>"><?php echo e($total_comments); ?></span><?php echo e(get_phrase('Comments')); ?>
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <span><?php echo e($sharecount); ?></span><?php echo e(get_phrase('Share')); ?>
                            ...
                            <div class="user-comments s_comment d-hidden bg-white" id="user-comments-<?php echo e($post->post_id); ?>">
                                ...
                                <?php if($comments->count() < $total_comments): ?>
                                    <a class="btn view_btn_text p-3 pt-0"
                                        onclick="loadMoreComments(this, <?php echo e($post->post_id); ?>, 0, <?php echo e($total_comments); ?>,'post')">
                                        <?php echo e(get_phrase('View more')); ?>
                    ...
                    <?php endif; ?> <!-- End of <?php if($post->post_type != 'fundraiser'): ?> -->
                ...
                <?php echo $__env->make('frontend.initialize', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\Voary\Piscine de Romain\AbracadamallReseau\AbracadamallReseau\resources\views/frontend/main_content/posts.blade.php ENDPATH**/ ?>