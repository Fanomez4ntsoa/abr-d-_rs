<div class="page-wrap">
    <div class="d-flex pagetab-head nblog_header p-20 radius-8  align-items-center justify-content-between  bg-white">
        <h3 class="h5 mb-0"> <?php echo e(get_phrase('Blogs')); ?></h3>
        <div class="inline-btn w-50">
            <a href="<?php echo e(route('create.blog')); ?>" class="btn common_btn"><i class="fa fa-plus-circle me-1"></i><?php echo e(get_phrase('Create Blog')); ?></a>
        </div>
    </div>
            ...
            <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-4" id="blog-<?php echo e($blog->id); ?>">
                    <article class="single-entry sblog_entry p-0">
                        <div class="entry-img">
                            <a href="<?php echo e(route('single.blog',$blog->id)); ?>"><img src="<?php echo e(get_blog_image($blog->thumbnail,'thumbnail')); ?>" alt="" class="img-fluid thumbnail-210-200"></a>
...
</div><?php /**PATH C:\Users\DELL\Desktop\Voary\Piscine de Romain\AbracadamallReseau\AbracadamallReseau\resources\views/frontend/blogs/category_blog.blade.php ENDPATH**/ ?>