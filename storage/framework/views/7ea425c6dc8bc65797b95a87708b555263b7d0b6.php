<div class="page-wrap">
    <div class="d-md-flex pagetab-head  align-items-center justify-content-between mb-3 bg-white mb-12 radius-8 p-20">
        ...
        <div class="d-flex ">
                <a href="javascript:void(0)" onclick="showCustomModal('<?php echo e(route('load_modal_content', ['view_path' => 'frontend.marketplace.create_product'])); ?>', '<?php echo e(get_phrase('Create Product')); ?>');" class="btn common_btn" data-bs-toggle="modal"
                    data-bs-target="#createProduct" class="btn common_btn"> <i class="fa fa-plus-circle"></i><?php echo e(get_phrase('Create Products')); ?></a>
            <a href="<?php echo e(route('userproduct')); ?>" class="btn common_btn mx-1"><?php echo e(get_phrase('My Products')); ?></a>
            <a href="<?php echo e(route('product.saved')); ?>" class="btn common_btn" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Saved Product"><?php echo e(get_phrase('Saved')); ?></a>
        </div>
    </div>
                ...
                <div class="col-md-7 col-lg-8 col-sm-12">
                    <div class="entry-text market_save">
                        ...
                        <div class="d-flex my-2">
                            <!-- Avatar -->
                            <div class="avatar">
                                <a href="<?php echo e(route('user.profile.view', $saved_product['user_id'])); ?>"><img class="h-39 avatar-img rounded-circle w-40 user_image_proifle_height" src="<?php echo e(get_user_image($saved_product->productData->getUser->photo,'optimized')); ?>"
                                        alt=""></a>
                            </div>
                            <div class="avatar-info ms-2">
                                <h4 class="ava-nave"><a href="<?php echo e(route('user.profile.view', $saved_product['user_id'])); ?>"><?php echo e($saved_product->productData->getUser->name); ?></a></h4>
...
<?php /**PATH C:\Users\USER\Downloads\Compressed\Piscine de Romain Avril\resources\views/frontend/marketplace/saved_product.blade.php ENDPATH**/ ?>